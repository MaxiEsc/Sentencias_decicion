...
monto_compra = float(input('ingrese el monto de tu compra? '))
...
# Hacemos los cálculos necesarios para obtener el monto final con el descuento de calculado desde la compra base.
if descuento != 0:
